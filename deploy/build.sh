...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --abi)              abis+=("$2");            shift 2 ;;
        --apple-arch)       APPLE_ARCHITECTURES="$2"; shift 2 ;;
        ...
        --help|-h|?)
            ...
            echo "  --apple-arch <archs>      - specify Apple architectures, e.g. arm64, x86_64, or arm64;x86_64"
...
[[ -n "$APPLE_ARCHITECTURES" ]]       && args+=("-DAMNEZIA_APPLE_ARCHITECTURES=$APPLE_ARCHITECTURES")
