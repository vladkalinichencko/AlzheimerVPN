if(APPLE)
    if(NOT DEFINED AMNEZIA_APPLE_ARCHITECTURES)
        if(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "arm64|aarch64|ARM64")
            set(AMNEZIA_APPLE_ARCHITECTURES "arm64" CACHE STRING "Apple target architectures")
        else()
            set(AMNEZIA_APPLE_ARCHITECTURES "x86_64" CACHE STRING "Apple target architectures")
        endif()
    endif()
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "iOS")
        ...
        set(CMAKE_OSX_ARCHITECTURES "${AMNEZIA_APPLE_ARCHITECTURES}" CACHE STRING "" FORCE)
    elseif(MACOS_NE)
