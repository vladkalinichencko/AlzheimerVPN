if(APPLE)
    set(AMNEZIA_APPLE_ARCHITECTURES "arm64" CACHE STRING "Apple target architectures" FORCE)
...
list(APPEND _CONAN_INSTALL_ARGS ${CONAN_INSTALL_ARGS})
list(PREPEND _CONAN_INSTALL_ARGS "--build=missing")
list(REMOVE_DUPLICATES _CONAN_INSTALL_ARGS)
